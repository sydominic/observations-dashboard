...
## 추가 수정: 부서 실행 책임 표현 보정
- 1페이지 권장 실행 순서 4단계 문구를 `부서별 조치계획 / QA 주관...`에서 `각 부서 조치계획 / 각 부서가 개선계획과 완료기준을 수립하고, QA는 기준·기록·CAPA 연계 검토 지원`으로 변경했습니다.
- 의도: 모든 관련 부서가 자체적으로 점검·개선 책임을 갖고, QA는 품질시스템 관점에서 기준 정합성 및 기록·CAPA 연계를 지원하는 구조로 표현했습니다.
